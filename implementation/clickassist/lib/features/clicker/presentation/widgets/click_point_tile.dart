...
class ClickPointTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label:
          '${clickPoint.label}. X ${clickPoint.x.toStringAsFixed(0)}, Y ${clickPoint.y.toStringAsFixed(0)}. Relative ${(clickPoint.xPercent * 100).toStringAsFixed(0)} percent by ${(clickPoint.yPercent * 100).toStringAsFixed(0)} percent.',
      child: Container(
                      ...
                      if (useCompactActions) ...[
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: onRemove,
                              tooltip: 'Delete target position',
                              icon: const Icon(
